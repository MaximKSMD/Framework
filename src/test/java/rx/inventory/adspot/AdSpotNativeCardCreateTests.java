...
public class AdSpotNativeCardCreateTests extends BaseTest {
    ...
    private static final String NATIVE_FLOOR_PRICE = "18.45";
    ...
    private void init() {
        ...
        publisher = publisher()
                .createNewPublisher(captionWithSuffix("0000autoPub1"), true, CURRENCY, Collections.emptyList(), Collections.emptyList())
                .build()
