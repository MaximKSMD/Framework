...
public class AdSpotVideoCardCreateTests extends BaseTest {
    ...
    private static final CategoriesList CATEGORY_EDUCATION = CategoriesList.EDUCATION;
    private static final CategoriesList CATEGORY_AUTO_REPAIR = CategoriesList.AUTO_REPAIR;
    ...
    public void checkInfoNativePanel() {
        var tableData = adSpotPage.getAdSpotsTable().getTableData();
    ...
    public void hoverMouseCursorOnDetailsIcon(TableData tableData) {
        testStart()
    ...
    public void verifySelectionInDetailsMenuForTableItem(DetailsSection detailsSection, String... expectedItemNames) {
