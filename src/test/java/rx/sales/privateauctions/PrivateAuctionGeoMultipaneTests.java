...
public class PrivateAuctionGeoMultipaneTests extends BaseTest {
    ...
    public PrivateAuctionGeoMultipaneTests() {
    ...
    private void checkDefaultGeoList() {
        var openPricingMultipane = privateAuctionSidebar.getGeoMultipane();
